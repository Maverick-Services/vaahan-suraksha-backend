...
import { getPaginatedMembers, getPaginatedUsers } from "../controllers/pagination.controller.js";
...
router.route("/members/paginated/").get(verifyJWT, getPaginatedMembers);
